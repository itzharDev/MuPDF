...
# Version 1+1: armeabi-v7a (Much faster due to the availability of hardware
# FP, but cannot be run in the emulator).
#APP_PLATFORM=android-14
#APP_ABI := armeabi-v7a

# Version 1+2: x86 (Requires android-9, so a change needs to be made in
# AndroidManifest.xml too)
#APP_PLATFORM=android-14
#APP_ABI := x86

# Version 1+3: mips (Requires android-9, so a change needs to be made in
# AndroidManifest.xml too)
#APP_PLATFORM=android-14
#APP_ABI := mips
